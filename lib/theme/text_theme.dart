...
class TextThemeStyle {
  static TextTheme light = const TextTheme(
    displayLarge: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Color.fromRGBO(188, 188, 191, 1), fontFamily: 'Nunito'),
    displayMedium: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color.fromRGBO(76, 76, 105, 1), fontFamily: 'Nunito'),
    displaySmall: TextStyle(fontSize: 10, fontWeight: FontWeight.w500, color: Color.fromRGBO(76, 76, 105, 1), fontFamily: 'Nunito'),
    headlineLarge: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Color.fromRGBO(188, 188, 191, 1), fontFamily: 'Nunito'),
    headlineMedium: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Color.fromRGBO(76, 76, 105, 1), fontFamily: 'Nunito'),
    headlineSmall: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Color.fromRGBO(188, 188, 191, 1), fontFamily: 'Nunito'),
    ...
    labelLarge: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: Color.fromRGBO(76, 76, 105, 1), fontFamily: 'Nunito'),
